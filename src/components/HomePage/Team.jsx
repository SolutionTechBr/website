        ...
        <div className='pt-10'>
            ...
            <div className='flex items-center lg:flex-row md:flex-row flex-col justify-center lg:gap-x-16 md:gap-x-8 w-full mt-0'>
                <div className='flex flex-col items-center justify-center gap-5 mt-5'>
                    {teams.slice(0, 3).map((team, idx) => <div data-aos="zoom-in" key={idx} className='flex lg:w-96 md:w-80 w-72 items-center bg-[#0a0a0a] border-gray-800 hover:border-gray-700 border p-2.5 rounded-2xl gap-4'>
                        <div className='bg-gray-900 p-1.5 rounded'>
                            <img src={team.icon} alt="blockchain" className='h-8 w-8' />
                        </div>
                        <div>
                            <p className='lg:text-xl md:text-xl text-lg text-gray-200 font-semibold pr-10'>{team.name} </p>
                        </div>
                    </div>)}
                </div>

                <div className='flex flex-col items-center justify-center gap-5 mt-5'>
                    {teams.slice(3, 8).map((team, idx) => <div data-aos="zoom-in" key={idx} className='flex lg:w-96 md:w-80 w-72 items-center bg-[#0a0a0a] border-gray-800 hover:border-gray-700 border p-2.5 rounded-2xl gap-4'>
                        <div className='bg-gray-900 p-1.5 rounded'>
                            <img src={team.icon} alt="blockchain" className='h-8 w-8' />
                        </div>
                        <div>
