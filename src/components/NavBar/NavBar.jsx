            ...
            <div className="flex items-center justify-between lg:w-[80rem] md:w-[100%] px-4 md:px-3 py-5 m-auto text-lg">
                <div className="flex items-center">
                    <Link style={{ textDecoration: "none" }} to="/" className="flex items-center">
                     <img data-aos="fade-up" src="./images/logo.mini.png" className='h-[4rem] ' alt="electric" />
                    ...
                    <ul className="md:flex gap-8 hidden items-center text-base">
                        ...
                        <li>
                            <NavLink style={{ textDecoration: "none" }} to="/">
                                {({ isActive, isPending }) => (
                                    <span className={`hover:underline underline-offset-4 decoration-blue-500 ${isActive ? "text-sky-500 font-medium" : "text-white"} `} >Página Inicial</span>
                                )}
                            </NavLink>
                        </li>
                        ...
                        <li>
                            <NavLink style={{ textDecoration: "none" }} to="/about">
                                {({ isActive, isPending }) => (
                                    <span className={`hover:underline underline-offset-4 decoration-blue-500 ${isActive ? "text-sky-500 font-medium" : "text-white"}`}>Sobre</span>
                                )}
                            </NavLink>
                        </li>
                        <li>
                            <NavLink style={{ textDecoration: "none" }} to="/team">
                                {({ isActive, isPending }) => (
                                    <span className={`hover:underline underline-offset-4 decoration-blue-500 ${isActive ? "text-sky-500 font-medium" : "text-white"}`}>Serviços</span>
                                )}
                            </NavLink>
                        </li>
                        <li>
